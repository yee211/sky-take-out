...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
        ...
        vo.setPackageStr("prepay_id=prepay_id_demo");
        vo.setNonceStr("nonce_str_demo");
        vo.setPaySign("pay_sign_demo");
     ...
     * @return
     */
    public PageResult selecthistoryOrder(OrdersPageQueryDTO ordersPageQueryDTO) {
...
*/
    ...
    public void reminder(Long id) {
        ...
        log.info("用户催单，订单号：{}", ordersDB.getNumber());
    }
}
